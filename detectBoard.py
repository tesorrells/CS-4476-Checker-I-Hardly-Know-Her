...
# Open image with board to detect board and obtain bird's eye view
image = cv2.imread('checkers/board1/IMG_4073.JPG')
...
if not boardContour is None:
    ...
    cv2.imshow("Board Found", imutils.resize(warped, height = int(h)))
